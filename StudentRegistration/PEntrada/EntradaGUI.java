...
public class EntradaGUI implements IEntrada
{
    ...
    /**
     * Método imprimirAlunos - Saida grafica 
     *
     * @param alunos String, alunos em formato de texto na interface
     */
    public void imprimirAlunos(String alunos){
        String texto = alunos; //texto recebe uma string que possui os dados dos alunos registrados
        ...
        String titulo = "Alunos cadastrados"; //define o titulo da janela

        //Instancia objeto e define as dimensões da janela em pixels
        Dimension tamanho = new Dimension(100, 500);
