...
public class Utils {
    ...
    public static boolean validarOperador(String op){
        ...
        if (!(op.equals("+") || op.equals("-") || op.equals("x") || op.equals("/") || op.equals("!"))) 
            return false;
        return true;
    }
    
    //funcao que verifica se a pessoa deseja fazer uma operacao de seno
    public static boolean validarSeno(String str){
        if(str.equals("sen") || str.equals("Sen") || str.equals("SEN") || str.equals("sin")){
            return true;       
        }
        return false;
    }
